...
export default function MainBanner() {
  ...
  return (
    <>
      <section
        className="h-[400px] relative bg-cover bg-center flex flex-col justify-center items-center bg-[url('/images/宿舍封面01.svg')] lg:bg-[url('/images/宿舍封面01.png')]"
        // style={{ backgroundImage: "url('/images/宿舍封面01.png')" }}
      >
      </section>
